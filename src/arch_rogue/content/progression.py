...
DISCIPLINES: tuple[Discipline, ...] = (
    ...
    Discipline(
        ...
        "Ranger",
        "Beast Bond",
        "Spirit Beast gains health and bite damage.",
        degree=1,
        path="Beast",
        prerequisites=(),
        melee_bonus=2,
    ...
    Discipline(
        ...
        "Ranger",
        "Pack Tactics",
        "Spirit Beast attacks faster and mauls snared foes harder.",
        degree=2,
        path="Beast",
    ...
    Discipline(
        ...
        "Ranger",
        "Alpha",
        "The Spirit Beast becomes a faster, tougher dire beast that knocks foes back.",
        degree=3,
        path="Beast",
    ...
    Discipline(
        ...
        "Ranger",
        "Spirit Companion",
        "The Spirit Beast gains arcane bites, health, damage, and speed.",
        degree=4,
        path="Beast",
