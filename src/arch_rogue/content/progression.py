...
SKILL_NODES: tuple[SkillNode, ...] = (
    ...
    SkillNode(
        ...
        "Warden",
        "Warden's Ward",
        "Time Skip lasts longer and steadies allies near the Warden.",
        tier=3,
        branch="Bulwark",
    ...
    SkillNode(
        ...
        "Warden",
        "Bulwark Wave",
        "Time Skip raises a brief stone ring and hardens the Warden's footing.",
        tier=2,
        branch="Fortress",
    ...
    SkillNode(
        ...
        "Acolyte",
        "Owl Companion",
        "The owl familiar persists and drains life from foes into the Acolyte.",
        tier=2,
        branch="Spirit",
