...
- :mod:`.abilities`     — enemy ability/tactic resolution tables (4.8.9, pure helpers).
- :mod:`.pathing`       — shared per-player navigation distance fields (4.8.9).
- :mod:`.enemies`       — enemy AI update, ability executors, perception.
...
- :mod:`.npc_allies`    — friendly NPCs that join the fight (4.8.10): greeting, ally AI, NPC damage sink.
...
from .npc_allies import _NpcAlliesCombatMixin
from .pathing import _PathingCombatMixin
