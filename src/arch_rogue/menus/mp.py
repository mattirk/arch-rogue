...
from ..constants import MP_RUN_ID_LENGTH, SHARED_SIGIL_NAMES
...
_MP_SEAL_SIGILS = SHARED_SIGIL_NAMES
...
class MenuMultiplayerMixin:
    ...
    def _draw_mp_archetype_panel(
        ...
        *,
        ...
        stats = (
            ...
            f"Stamina {archetype.max_stamina}"
            f" · Move {round(archetype_move_bonus(archetype.speed) * 100):+d}%",
        ...
        if any(
            ...
            stats = (
                ...
                f"ST {archetype.max_stamina}"
                f" · MV {round(archetype_move_bonus(archetype.speed) * 100):+d}%",
    ...
    def draw_mp_lobby(self) -> None:
        ...
        panel, content = self.menu_frame("Two are bound to Descend", subtitle)
