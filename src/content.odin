...
BOSS_DEFS := [Boss_Id]Boss_Def{
	.Ash_Gallows = {
		...
		max_hp = 350, speed = 1.04, damage = 17, xp = 62,
	...
	.Mycelial_Matron = {
		...
		max_hp = 250, speed = 0.94, damage = 15, xp = 58,
	...
	.Rime_Chanter = {
		...
		max_hp = 200, speed = 0.99, damage = 14, xp = 60,
	...
	.Void_Sentinel = {
		...
		max_hp = 300, speed = 0.80, damage = 18, xp = 68,
	...
	.Gate_Tyrant = {
		...
		max_hp = 600, speed = 0.94, damage = 21, xp = 120,
