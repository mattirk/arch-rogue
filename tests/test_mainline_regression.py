...
class DesktopDeterminismTests(unittest.TestCase):
    ...
    # 4.9: rebaselined for the story rewrite — the theater overlay now shows
    # the budgeted omen text (narrator "Nim Rue"), then for the bigger
    # cutscene fonts + page-medallion glyph, then for the longer "more
    # revealing" texts (dilemma truth sentences ride in the omens the baked
    # scenes capture mid-typewriter). Determinism re-verified across two
    # processes each time.
    # ...and finally for the letter-spaced narration rendering.
    GAMEPLAY_HASH = "c3b11811fe842ef7548eb1190eca8d9c7687263b03efa7ad4b4dc63b7721ccde"
    CROWD_HASH = "1cda1424e83a09d840c3de569ae9b9edc65ab403508af426b12620c66faede15"
