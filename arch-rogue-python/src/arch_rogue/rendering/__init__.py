...
from .fog import FogOfWarMixin
from .hud import RenderingHudMixin
from .minigames import RenderingMiniGameMixin
from .minimap import RenderingMinimapMixin
...
class RenderingMixin(
    ...
    RenderingHudMixin,
    RenderingMinimapMixin,
    RenderingMiniGameMixin,
