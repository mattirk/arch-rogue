...
class RoomLifecycleTests(unittest.TestCase):
    ...
    def test_relay_paths_and_intent_stamping(self) -> None:
        ...
        mini_game_intent = host.last("intent")
        self.assertEqual(mini_game_intent["player_id"], "p2")
        self.assertEqual(mini_game_intent["action"], "minigame")
        self.assertEqual(mini_game_intent["target"], "7:4:2")
        h.hub.handle_message(
            join_conn,
            {
                "t": "intent",
        ...
        ready_intent = host.last("intent")
        self.assertEqual(ready_intent["player_id"], "p2")
        self.assertEqual(ready_intent["target"], "7:ready")
