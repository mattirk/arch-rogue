    ...
    def test_draw_shadow_applied_consistently_to_all_actors_and_props(
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                # confirm player, enemy, shopkeeper, story guest, loot,
                # shrine, and secret all ground through the soft contact
                # shadow — and that flat floor traps cast none (a drop shadow
                # under the flat plate read as the trap hovering mid-air).
                seen: list[str] = []
                ...
                self.assertFalse(any(s == "28x11" for s in seen))  # trap: none
