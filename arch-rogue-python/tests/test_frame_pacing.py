...
class FrameRateOptionTests(unittest.TestCase):
    ...
    def test_default_options_serialize_schema_10_with_cap_and_overlay(self) -> None:
...
class OptionsRowCountTests(unittest.TestCase):
    ...
    def test_desktop_row_count_includes_perf_overlay(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # 4.11.0: one fewer row — the music row is parked until real
            # tracks exist.
            ...
            self.assertEqual(game.OPTIONS_ROW_FRAME_RATE, 5)
