...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--graphics-tier",
        choices=GRAPHICS_TIER_VALUES,
        default=GRAPHICS_TIER_DEFAULT,
        help="Graphics source/render path to profile (default: HD).",
    )
    parser.add_argument(
        "--mobile",
        action="store_true",
    ...
    parser.add_argument(
        ...
        default="performance",
        help="Logical render mode used with --mobile (width/height remain physical).",
    )
    parser.add_argument(
        "--no-lighting",
        action="store_true",
...
def prepare_game(args: argparse.Namespace, temp_dir: Path) -> Game:
    ...
    game.set_graphics_tier(args.graphics_tier)
